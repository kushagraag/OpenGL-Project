...
int main()
{
	...
	// Vertices coordinates for triangles
	GLfloat vertices[] =
	{
		-0.5f, -0.5f * float(sqrt(3)) / 3, 0.0, // Lower left corner
		0.5f, -0.5f * float(sqrt(3)) / 3, 0.0, // Lower right corner
		0.0f, 0.5f * float(sqrt(3)) * 2 / 3, 0.0, // Upper corner
